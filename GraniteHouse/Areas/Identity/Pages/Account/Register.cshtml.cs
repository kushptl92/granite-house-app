...
namespace GraniteHouse.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new Users { UserName = Input.Email, Email = Input.Email, Name=Input.Name,PhoneNumber=Input.PhoneNumber };
                ...
                if (result.Succeeded)
                {
                    ...
                    return RedirectToAction("Index","UsersMgmt",new {Area="Admin" });
